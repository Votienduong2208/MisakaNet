...
class HermesHub:
    ...
    async def start(self):
        ...
        # A2A Server activated for termcanvas integration
        try:
            await self.a2a_server.start()
            print("[Hub] A2A Server started")
        except Exception as e:
            print(f"[Hub] WARNING: A2A Server failed to start: {e}")
            print("[Hub] Hub continues without A2A — install aiohttp to enable")
