...
> Domain: devops | Tags: ccswitch, hermes-switch, model, switching, proxy, deepseek, mioffice | Source: hermes_wsl
...
2. 更新 `C:/Users/User/.claude/settings.json`（Windows 侧）
...
```bash
# cc 跑 DeepSeek，Hermes 跑 Mimo（省 Hermes token）
ccswitch ds-flash
hermes-switch mimo-2.5-pro

# cc 跑 Mimo，Hermes 跑 DeepSeek（cc 省 token）
ccswitch mimo-2.5-pro
...
| mimo-2.5-pro | xiaomi/mimo-v2.5-pro | Mioffice |
| mimo-2.5 | xiaomi/mimo-v2.5 | Mioffice |
| mimo-2-pro | xiaomi/mimo-v2-pro | Mioffice |
| mimo-flash | xiaomi/mimo-v2-flash | Mioffice |
...
- `/tmp/proxy_env.sh` — Mioffice API key
